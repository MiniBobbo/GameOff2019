...
export class C {
    ...
    'Level 19', 'Level 20', 'Level 21', 'Level 22', 'Level 23', 'Level 24', 'Level 25', 'Level 26', 'Level 27', 'Level 28'];
    ...
    static CreateLevelData() {
        ...
        C.CreateLevelCondition('Level 28', 'Poison the well.', (level:TsetScene) =>{
            if(level.touchingFlag && level.thingCollected == 1)
            return true;
            return false;
        });
